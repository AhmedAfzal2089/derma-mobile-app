...
export default function RecentBlogs() {
  return (
    <View className="bg-zinc-950 mx-4 p-6 my-6 py-14 items-center rounded-xl">
      {/* Title */}
      <Text className="text-2xl font-bold text-center text-white mb-2">Recent Blogs</Text>
      ...
      <Link href="/blogs" asChild>
        <TouchableOpacity className="px-6 py-4 bg-white rounded-md shadow-lg">
          <Text className="text-zinc-900 font-semibold text-base">VIEW ALL BLOGS</Text>
        </TouchableOpacity>
      </Link>
    </View>
  );
